  ...
  return (
    <>
        <div className="w-full mx-auto lg:w-10/12">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 xl:grid-cols-3 md:grid-cols-3 mb-9 md:gap-9">
                <div className="custom-card-image mb-7 md:mb-0">
            ...
            <div className="w-full py-6 mb-7 rounded-lg shadow-md bg-base-200 stats">
                <div className="stat">
